...
| T-1.5 | wgpu device/surface + CADisplayLink present loop + keep-warm | ready-for-agent | T-1.3 |
| T-1.6 | Glyph atlas + monospace grid fast-path (cosmic-text/swash) | ready-for-agent | T-1.5 |
| T-1.7 | Tier-1 iai-callgrind micro-benches (parse/grid/frame-build) | ready-for-agent | T-1.4 |
...
| T-2.2 | Shell-integration shim extraction + ZDOTDIR/ENV/XDG injection | ready-for-agent | T-1.1 |
...
| T-3.7 | Shared history ring + per-mode query lens | ready-for-agent | T-3.1 |

### EPIC-4 - Design system pass
| id | title | status | depends_on |
|---|---|---|---|
| T-4.1 | aterm-tokens: semantic tokens + spacing/type scale | ready-for-agent | - |
